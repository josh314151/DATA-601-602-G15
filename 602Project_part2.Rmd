...
data_s3 = read.csv("summary_data_subgroup_3.csv")
...
```{r}
ggplot(data_s1, aes(x = Age, y = Average_HR)) + geom_smooth(method = "lm") + geom_point() + xlab("Age") + ggtitle("Age vs Average HR") 
predicted_rate = lm(Average_HR ~ Age, data=data)
predicted_rate$coef
```
